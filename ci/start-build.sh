...
REPO="git@github.com:starschema/virtdb-fsm.git"
BUILDNO=`git ls-remote --tags $REPO 2>&1 | ./new_build_tag.pl`
export BUILDNO
IMAGE_NAME="virtdb-build:centos6-fsm-builder"
...
docker run --rm=true -e "GITHUB_EMAIL=$GITHUB_EMAIL" \
                     ...
                     -e "BUILDNO=$BUILDNO" \
                     -v $PWD/build-result:/home/virtdb-demo/build-result -t $IMAGE_NAME ./build-fsm.sh $*
